...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp11(BehaviorContext p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp12(TMPro.TMP_Text p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public bool __Gen_Delegate_Imp13(UnityEngine.Collider p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp14(UnitActualDataPanel p0, UnitActualDataPanel p1, UnityEngine.GameObject p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(EnemyAnimatorDriver.BehaviorFunc))
			{
			    return new EnemyAnimatorDriver.BehaviorFunc(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(TaskPanel.TaskDisplayAction))
			{
			    return new TaskPanel.TaskDisplayAction(__Gen_Delegate_Imp12);
			}
		
		    if (type == typeof(AreaDetector_Box.TriggerFliterDel))
			{
			    return new AreaDetector_Box.TriggerFliterDel(__Gen_Delegate_Imp13);
			}
		
		    if (type == typeof(AreaDetector_Sphere.TriggerFliterDel))
			{
			    return new AreaDetector_Sphere.TriggerFliterDel(__Gen_Delegate_Imp13);
			}
		
		    if (type == typeof(BulletDriverModule.AttackHitEnemyDel))
			{
			    return new BulletDriverModule.AttackHitEnemyDel(__Gen_Delegate_Imp14);
			}
		
		    if (type == typeof(BulletDriverModule.AttackHitPlayerDel))
			{
			    return new BulletDriverModule.AttackHitPlayerDel(__Gen_Delegate_Imp14);
			}
		
		    if (type == typeof(TaskSystem.TaskAction))
			{
			    return new TaskSystem.TaskAction(__Gen_Delegate_Imp15);
			}
