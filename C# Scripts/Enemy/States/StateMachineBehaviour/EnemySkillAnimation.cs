...
public class EnemySkillAnimation : StateMachineBehaviour
{
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        if (animator.GetCurrentAnimatorStateInfo(0).normalizedTime <= 0.2f)
        {
            ...
            driver.transform.rotation = Quaternion.Lerp(driver.transform.rotation, ro, Time.deltaTime * 10f);
        }
    ...
    {
        driver.enemyAIData.moveAllowed = true;
    }
